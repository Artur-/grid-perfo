...
import * as viewEndpoint from '../../generated/TSEndpoint';
...
import styles from './t-s-view.css';

@customElement('t-s-view')
export class TSViewElement extends LitElement {
  static get styles() {
    ...
    return html`
      <vaadin-split-layout class="full-size">
        <div class="grid-wrapper">
          <vaadin-grid id="grid" class="full-size" theme="no-border">
